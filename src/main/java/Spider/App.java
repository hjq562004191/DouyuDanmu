...
public class App {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        //发送登录请求(登入9999房间)
        String loginCMD = "type@=loginreq/roomid@=99999/";
        ...
        while (true){
            ...
            if (s.contains("chatmsg")) {
                String[] strings = s.split("/");
                if (strings[4].contains("nn@=")) {
                    String s1 = strings[4].replaceAll("nn@=", "昵称:");
                    System.out.print(s1);
                    System.out.println(strings[5].replaceAll("txt@=","---弹幕内容:"));
                }else {
                    String s1 = strings[3].replaceAll("nn@=", "昵称:");
                    System.out.print(s1);
                    System.out.println(strings[4].replaceAll("txt@=","---弹幕内容:"));
                }
            }
//            System.out.println(s);
    ...
    public static byte[] read(Socket socket) {
        ...
        try {
            ...
            ByteArrayOutputStream byteArray = new ByteArrayOutputStream();
            while (contentLen > 0 && (len = inputStream.read(bytes, 0, contentLen - readLen)) != -1) {
